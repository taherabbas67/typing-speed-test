...
const firebaseConfig = {
  apiKey: "AIzaSyCzOBTdsOuuDgMZOoVOzuyHUe_MIVVPhnE",
  authDomain: "typing-test-f3ae0.firebaseapp.com",
  databaseURL: "https://typing-test-f3ae0-default-rtdb.firebaseio.com",
  projectId: "typing-test-f3ae0",
  storageBucket: "typing-test-f3ae0.appspot.com",
  messagingSenderId: "92360511575",
  appId: "1:92360511575:web:f9bcd45677f8cf632e5312",
  measurementId: "G-JG9B8NBPMQ"
};
firebase.initializeApp(firebaseConfig);

// Get a reference to the scores collection in Firebase Realtime Database
const scoresRef = firebase.database().ref('scores');

// Save the score data to Firebase Realtime Database
function saveScore(wordsSubmitted, wordsCorrect) {
  let percentageAcc = 0;
  if(wordsSubmitted!==0){
  ...
  scoresRef.push({accuracy: percentageAcc, wpm: wpm})
    .then(() => {
      console.log('Score data saved to Firebase Realtime Database.');
    })
    .catch((error) => {
      console.error('Error saving score data to Firebase Realtime Database:', error);
    });
}

// Display the score and save it to Firebase Realtime Database
function displayScore(){
  ...
  // Save the score data to Firebase Realtime Database
  saveScore(wordsSubmitted, wordsCorrect);
}
